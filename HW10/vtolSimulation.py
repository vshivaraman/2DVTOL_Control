...
import sys 
sys.path.append('..')
#sys.path.append('/home/shivaraman/python_projects/Project_Drone/HW7')
from HW10.vtolDynamics import vtolDynamics
...
reference_2 = signalGenerator(amplitude=1, frequency=1)
