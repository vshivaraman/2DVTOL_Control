...
class dataPlotter:
    ...
    def __init__(self):
        ...
        #self.handle.append(myPlot(self.ax[3],xlabel='t',ylabel='Force'))
    ...
    def update(self, t, reference, states, ctrl):
        ...
        self.h_ref_history.append(reference[1]) # reference position
        self.h_history.append(states.item(1))
        self.theta_history.append(180.0/np.pi*states.item(2))  # rod angle (converted to degrees)
        ...
        self.handle[1].update(self.time_history, [self.h_history,self.h_ref_history])
